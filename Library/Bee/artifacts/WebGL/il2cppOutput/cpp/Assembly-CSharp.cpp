...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void collector_Start_m65276C48A63A8D217822776CE6A32C4A26375B60 (collector_tEBF92C62743EEF3431C1272AAD3719963B853D32* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		int32_t L_6 = __this->___height_6;
...
{
	{
		...
		__this->___height_6 = ((int32_t)il2cpp_codegen_subtract(L_0, 1));
		// this.transform.localPosition=new Vector3(0,-height,1);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_1;
		L_1 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		int32_t L_2 = __this->___height_6;
...
IL_003b:
	...
	}
	{
		...
		// height+=1;
		int32_t L_13 = __this->___height_6;
		__this->___height_6 = ((int32_t)il2cpp_codegen_add(L_13, 1));
		// gameManager.CollPos();
		...
		GameManager_tFE129A0017AF5BBD30FDCD4403B9CCEAE064C6B6* L_15 = __this->___gameManager_5;
		...
		// mainCube.transform.position=new Vector3(transform.position.x, height+1, transform.position.z);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_17 = __this->___mainCube_4;
		...
		int32_t L_22 = __this->___height_6;
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_26), L_21, ((float)((int32_t)il2cpp_codegen_add(L_22, 1))), L_25, /*hidden argument*/NULL);
		Transform_set_position_mA1A817124BB41B685043DED2A9BA48CDF37C4156(L_18, L_26, NULL);
		// this.transform.localPosition=new Vector3(0,-height,1);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_27;
		L_27 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		int32_t L_28 = __this->___height_6;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_29;
		memset((&L_29), 0, sizeof(L_29));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_29), (0.0f), ((float)((-L_28))), (1.0f), /*hidden argument*/NULL);
		...
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_30 = ___other0;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_31;
		L_31 = Collision_get_gameObject_m846FADBCA43E1849D3FE4D5EA44C02D055A70B3E(L_30, NULL);
		CollCube_tA5A7C7B5BCABBA766F8C83C4B41E45D337A89B1E* L_32;
		L_32 = GameObject_GetComponent_TisCollCube_tA5A7C7B5BCABBA766F8C83C4B41E45D337A89B1E_mF6DBD7C4413996E0BC96EEE8842CD0CC2046C092(L_31, GameObject_GetComponent_TisCollCube_tA5A7C7B5BCABBA766F8C83C4B41E45D337A89B1E_mF6DBD7C4413996E0BC96EEE8842CD0CC2046C092_RuntimeMethod_var);
		CollCube_doColl_m6BA57EF3F6F1F4E2E2C9333406970869D74C7C4C(L_32, NULL);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_36 = __this->___mainCube_4;
		...
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_38 = ___other0;
		...
		L_41 = Collision_get_transform_mA5D135D9F696635EA7A0D2184CEF499427A6D0F6(L_40, NULL);
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_44), (0.0f), L_43, (0.0f), /*hidden argument*/NULL);
		Transform_set_localPosition_mDE1C997F7D79C0885210B7732B4BA50EE7D73134(L_39, L_44, NULL);
	}
